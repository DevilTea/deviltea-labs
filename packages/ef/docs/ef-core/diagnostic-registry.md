...
| `EF-RES-020` | error | Resource representation and ownership | defined by the owning command and validation-completeness contract | [06-resources.md](06-resources.md) | Required normative Resource syntax validation failed |
