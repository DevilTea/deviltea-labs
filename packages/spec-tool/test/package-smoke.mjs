...
try {
	...
	const repositorySkills = join(process.cwd(), '..', '..', 'skills')
	...
	check('repository maintain skill matches packaged source', readFileSync(join(repositorySkills, 'maintain-spec-workspace', 'SKILL.md'), 'utf8') === readFileSync(join(process.cwd(), 'skills', 'maintain-spec-workspace', 'SKILL.md'), 'utf8'))
	check('repository review skill matches packaged source', readFileSync(join(repositorySkills, 'review-spec-workspace', 'SKILL.md'), 'utf8') === readFileSync(join(process.cwd(), 'skills', 'review-spec-workspace', 'SKILL.md'), 'utf8'))
