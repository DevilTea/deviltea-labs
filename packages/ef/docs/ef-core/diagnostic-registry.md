...
| `EF-FS-009` | error | Filesystem, configuration, and workspace | defined by the owning command and validation-completeness contract | [11-filesystem-and-config.md](11-filesystem-and-config.md) | Missing or non-canonical `.engineering/.gitignore` control file |
